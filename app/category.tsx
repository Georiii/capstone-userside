...
export default function Category() {
  const categories = [
    { name: 'T-shirts', icon: 'shirt' as const },
    { name: 'Formals', icon: 'business' as const },
    { name: 'Jackets/\nsweatshirt', icon: 'shirt' as const },
    { name: 'Shirt/\ncamisole', icon: 'shirt' as const },
  ];
          ...
          {categories.map((category, index) => (
            ...
            >
              <View style={styles.categoryImage}>
                <Ionicons name={category.icon} size={50} color="#333" />
              </View>
