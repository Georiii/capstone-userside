...
export default function AccessoriesCategory() {
  const accessoryTypes = [
    { name: 'Bags', icon: 'bag' as const },
    { name: 'Jewelry', icon: 'diamond' as const },
    { name: 'Belts', icon: 'bag' as const },
    { name: 'Scarves', icon: 'bag' as const },
    { name: 'Hats', icon: 'bag' as const },
    { name: 'Sunglasses', icon: 'bag' as const },
  ];
