...
export default function ShoesCategory() {
  const shoeTypes = [
    { name: 'Sneakers', icon: 'football' as const },
    { name: 'Heels', icon: 'football' as const },
    { name: 'Boots', icon: 'football' as const },
    { name: 'Sandals', icon: 'football' as const },
    { name: 'Flats', icon: 'football' as const },
    { name: 'Loafers', icon: 'football' as const },
  ];
